...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { Address: @trainer.Address, Name: @trainer.Name, current_weight: @trainer.current_weight, email_address: @trainer.email_address, gender: @trainer.gender, height: @trainer.height, string: @trainer.string } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { Address: @trainer.Address, Name: @trainer.Name, current_weight: @trainer.current_weight, email_address: @trainer.email_address, gender: @trainer.gender, height: @trainer.height, string: @trainer.string } }
